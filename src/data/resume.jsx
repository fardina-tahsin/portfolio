export const resume = {
  ...
  experience: [
    {
      title: "EDU Computer Club",
      role: "Sub-Executive",
      period: "Oct, 2023 - Dec, 2024",
      bullets: [
        "Assisted in organizing and supporting university-level programming contests and workshops.",
        "Worked collaboratively in a team environment to facilitate technical event coordination and club activities.",
      ],
    },
  ],
  ...
  projects: [
    {
      name: "BoardVect",
      image: "/projects/BoardVect.png", 
      category: "Full Stack",
      techStack: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Zustand", "Django", "SQLite"],
      description: "A productivity platform combining Kanban task management and image annotation, featuring JWT authentication, drag-and-drop workflows, polygon-based annotations.",
      githubUrl: "https://github.com/fardina-tahsin/boardvect",     
    },
    {
      name: "KrishiRokkha",
    ...
    {
      name: "JuiceBar",
      image: "/projects/JuiceBar.png", 
      category: "Full Stack",
      techStack: ["HTML", "CSS", "JavaScript", "Node.js", "Express.js", "MongoDB", "Docker"],
      description: "An e-commerce platform featuring user authentication, dynamic cart functionality and a responsive user interface with a containerized architecture.",
      githubUrl: "https://github.com/fardina-tahsin/JuiceBar-E-commerce-Website",     
    },
    {
      name: "ProdShop",
      image: "/projects/ProdShop.png", 
      category: "Full Stack",
      techStack: ["React", "CSS", "FastAPI", "Python", "PostgreSQL", "SQLAlchemy"],
      description: "A product inventory management application with CRUD operations, search capabilities and sortable product listings for inventory handling.",
      githubUrl: "https://github.com/fardina-tahsin/product-web",     
    },
    {
    ...
    },
    {
      ...
      description: "A fun and interactive game that features an animated teddy which reacts to wrong guesses instead of the traditional hangman.",
      githubUrl: "https://github.com/fardina-tahsin/word-game-react",     
    },
    {
      name: "SecureVault",
  ...
  skills: [
    {
      category: "Languages", number:"01", emoji: "< />",
      items: [
    ...
    {
      category: "Frontend", number: "02", emoji: "[ ]",
      items: [
    ...
    {
      category: "Backend", number: "03", emoji: "{ }",
      items: [
    ...
    {
      category: "Databases", number: "04", emoji: "[db]",
      items: [
    ...
    {
      category: "Tools", number: "05", emoji: ">>",
      items: [
    ...
    {
      category: "AI / ML", number: "06", emoji: "~AI~",
      items: [
